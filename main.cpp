...
int main() {
    ...
    std::cout << "Marketing name: " << gpusFound[0].getStaticDeviceData()->getMaxShaderClock()<< std::endl;
    std::cout << "Marketing name: " << gpusFound[0].getMonitoringData()->getCurrentMemoryClock()<< std::endl;
